...
Item {
    ...
    readonly property bool _deferShow: (typeof PulseGCSStartupController !== "undefined") && PulseGCSStartupController.active
    ...
    function _applyRestoredVisibility() {
